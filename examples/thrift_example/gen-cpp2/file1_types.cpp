...
#include "if/gen-cpp2/file1_types.tcc"

#include <algorithm>
#include <folly/Indestructible.h>

#include "if/gen-cpp2/file1_data.h"
...
void Struct0::__clear() {
  ...
  ::apache::thrift::Cpp2Ops<  ::cpp2::Struct27>::clear(&field12);
  field13 = 0;
  field14 = 0;
  field15 = 0;
  ::apache::thrift::Cpp2Ops<  ::cpp2::Struct17>::clear(&field16);
  field17.clear();
  __isset.__clear();
}
...
const  ::cpp2::Struct27& Struct0::get_field12() const& {
  return field12;
}

 ::cpp2::Struct27 Struct0::get_field12() && {
  return std::move(field12);
}

const  ::cpp2::Struct17& Struct0::get_field16() const& {
  return field16;
}

 ::cpp2::Struct17 Struct0::get_field16() && {
